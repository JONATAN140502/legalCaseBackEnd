...
class ReportControllerindecopi extends Controller
{
    ...
    protected function pdfexptramite(Request $request)
    {
        ...
        $tipo = ' Reporte de Expedientes Indecopi en Trámite';
        ...
        return \PDF::loadView('indecopi/pdfExpedienteTramite', compact('data1', 'data2', 'data3', 'data4', 'data5', 'tipo'))
            ->download();
    }
    protected function pdfexparchivados(Request $request)
    {
        ...
        $tipo = ' Reporte de Expedientes Indecopi Archivados';
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
    ...
    protected function pdfexpejecucion(Request $request)
    {
        ...
        $tipo = "Reporte de Expedientes Indecopi en Ejecución";
    ...
    protected function pdfexps(Request $request)
    {
        ...
        $tipo = "Reporte del Total de Expedientes Indecopi";
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
...

    {
        ...
        $tipo = "Reporte del  de Expedientes Indecopi de Mes y Año";
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
    ...
    protected function pdfexpsabogado(Request $request)
    {
        ...
        $tipo = 'Expedientes Indecopi  a cargo de:' . $abogado->persona->nat_nombres . '
    ...
    protected function pdfpretension(Request $request)
    {
        ...
        $tipo = "Reporte de Expedientes Indecopi por Delito:" . $pre->pre_nombre;
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
...

    {
        ...
        $tipo = "Reporte de Expedientes Indecopi del:" . date('d-m-Y', strtotime($request->fechaDesde)) . ' al 
    ...
    public function contarExpedientesPorAnio(Request $request)
    {
        ...
        return \PDF::loadView('indecopi/graficodebarras', compact('data'))
            ->download();
    }
    public function contarExpedientesPorAboTipo(Request $request)
    {
        ...
        $pdf = PDF::loadView('indecopi/graficodetorta', compact('chartUrl'));
        return $pdf->download();
    }
