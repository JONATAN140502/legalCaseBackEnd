...
class ReportControllerarbitral extends Controller
{
    ...
    protected function pdfexptramite(Request $request)
    {
        ...
        $tipo = ' Reporte de Expedientes Arbitrales en Trámite';
        ...
        return \PDF::loadView('arbitral/pdfExpedienteTramite', compact('data1', 'data2', 'data3', 'data4', 'data5', 'tipo'))
            ->download();
    }
    protected function pdfexparchivados(Request $request)
    {
        ...
        $tipo = ' Reporte de Expedientes Arbitrales Archivados';
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
    ...
    protected function pdfexpejecucion(Request $request)
    {
        ...
        $tipo = "Reporte de Expedientes Arbitrales en Ejecución";
    ...
    protected function pdfexps(Request $request)
    {
        ...
        $tipo = "Reporte del Total de Expedientes Arbitrales";
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
...

    {
        ...
        $tipo = "Reporte del  de Expedientes Arbitrales de Mes y Año";
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
    ...
    protected function pdfexpsabogado(Request $request)
    {
        ...
        $tipo = 'Expedientes Arbitrales  a cargo de:' . $abogado->persona->nat_nombres . '
    ...
    protected function pdfpretension(Request $request)
    {
        ...
        $tipo = "Reporte de Expedientes Arbitrales por Delito:" . $pre->pre_nombre;
        $totalRegistros = count($formattedData);
        $quinto = ceil($totalRegistros / 5);
        $data1 = array_slice($formattedData, 0, $quinto);
        $data2 = array_slice($formattedData, $quinto, $quinto);
...

    {
        ...
        $tipo = "Reporte de Expedientes Arbitrales del:" . date('d-m-Y', strtotime($request->fechaDesde)) . ' al 
    ...
    public function contarExpedientesPorAnio(Request $request)
    {
        ...
        return \PDF::loadView('arbitral/graficodebarras', compact('data'))
            ->download();
    }
    public function contarExpedientesPorAboTipo(Request $request)
    {
        ...
        $pdf = PDF::loadView('arbitral/graficodetorta', compact('chartUrl'));
        return $pdf->download();
    }
